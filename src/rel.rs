    ...
    fn dual_or_does_not_swap_children() {
        ...
        match d {
            Rel::Or(da, db) => {
                ...
                assert!(
                    structurally_equal(&dual(da.as_ref()), &expected_left),
                    "Left child should remain left"
                );
                assert!(
                    structurally_equal(&dual(db.as_ref()), &expected_right),
    ...
    fn dual_and_does_not_swap_children() {
        ...
        match d {
            Rel::And(da, db) => {
                ...
                assert!(
                    structurally_equal(&dual(da.as_ref()), &expected_first),
                    "First child should remain first"
                );
                assert!(
                    structurally_equal(&dual(db.as_ref()), &expected_second),
